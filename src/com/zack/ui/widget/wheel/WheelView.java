...
package com.zack.ui.widget.wheel;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.widget_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.widget_wheel_bg);
	}
